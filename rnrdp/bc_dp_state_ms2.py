...
ALGO_NAME = "BC_Diffusion_state_UNet_DP"
...
def parse_args():
    ...
    parser.add_argument("--demo-path", type=str, default='data/v0/rigid_body/StackCube-v0/trajectory.state.pd_ee_delta_pos.h5',
    ...
    def get_eval_action(self, obs_seq):
        ...
        with torch.no_grad():
            ...
            for k in self.noise_scheduler.timesteps:
                # predict noise or sample, ref as `model_output` for both prediction type
