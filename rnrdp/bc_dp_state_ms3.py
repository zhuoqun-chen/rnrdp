...
from mani_skill.utils.wrappers import (  # type: ignore
    CPUGymWrapper,
    RecordEpisode,
)
...
def parse_args():
    ...
    parser.add_argument("--demo-type", type=str, default=None) # NOTE: new in MS3
...
def make_env(env_id, seed, control_mode=None, video_dir=None, other_kwargs={}):
    def thunk():
        ...
        # env = gym.wrappers.RecordEpisodeStatistics(env) # NOTE: error: Attempted to add episode stats when they already exist (seems no longer needed in ms3)
