...
from mani_skill.utils import common  # type: ignore
from mani_skill.utils.wrappers import CPUGymWrapper, RecordEpisode  # type: ignore
from mani_skill.utils.wrappers.frame_stack import FrameStack  # type: ignore
...
def reorder_keys(d, ref_dict):
    ...
    for k, v in ref_dict.items():
        if isinstance(v, dict) or isinstance(v, gym.spaces.Dict):
